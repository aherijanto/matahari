	...
	<body bgcolor="#FFFAF1">
		...
		<form action="" method="post">
			...
			<table width="100%" font="calibri">
				<th align="center">INVOICE NO</th><th align="center">REFERENCE NO</th><th align="center">INVOICE DATE</th><th align="center">DUE DATE</th><th align="center">SUPPLIER</th>
				<tr>
		...
		<div class="txt-heading">
			<a id="btnNew" href="/purchase.php?action=new" style="color:white;background-color:   #2874a6   ; border-radius: 5px;text-decoration: none;padding: 10px">New</a>  
			<a id="btnSave" href="/purchase.php?action=save" style="color:white;background-color: #229954; border-radius: 5px;text-decoration: none;padding: 10px">Save</a> 
			<a id="btnEmpty" href="/purchase.php?action=empty" style="color:white;background-color:  #cb4335  ; border-radius: 5px;text-decoration: none;padding: 10px">Clear</a>
		</div>
		...
		<tr>
			<td align="center">
				<form method="post" action="/purchase.php?action=search" >
					<input name="itemcode" type="text" align="center" id="itemcode">
					<input type="submit" name="idsubmit" value="Search ID" />
				</form>
			</td>
			<td align="center">
				<form method="post" action="/purchase.php?action=search" >
					<input name="itemname" type="text" align="center" id="itemname">
					<input type="submit" name="namesubmit" value="Search Name" />
				</form>
			</td>
		<tr>
	</table>
