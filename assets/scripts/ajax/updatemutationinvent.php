<?php
    ...
    if($_POST['icodesource']){
        ...
        $sqlupdatesource = "UPDATE winventory SET i_qty = i_qty - $qtysource WHERE i_code='$icodesource'";
        $sqlupdatedestination = "UPDATE winventory SET i_qty= i_qty + $qtydestination WHERE i_code='$icodedestination'";
