...
<table height="40px" width="100%">
  ...
  $mytime=date("h:i:sa"); $showdate=$_SESSION['mydatedb'];
  if (isset($_SESSION['user'])){
  ...
  ?>
	...
	<tr>
		...
		<td align="center"><font face="calibri" size="2"><b><?php echo $username; ?></b></font></td>
...
<footer align="center"><a href="searchengine1.php"><font face="calibri" size="2">&copySBK</font><a></footer>
</body>
</html>
