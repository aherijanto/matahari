...
function newTrans() {
  $.ajax({
    type: "POST",
    url: "/assets/scripts/ajax/newaccp.php",
    data: "",
    success: function (response) {
...
function puttoarrayaccr(mydate,mytype,mynocheque,myamount) {
  ...
  $.ajax({
    type: "POST",
    url: "/assets/scripts/ajax/puttoarrayaccp.php",
    data:
      "mydate=" +
      mydate.trim() +
      "&mytype=" +
...
function accrSave(noinv){
    ...
    var noinv =$("#noinv").html();
      ...
      $.ajax({
        type: "POST",
			  crossDomain: true,
        url: "/assets/scripts/ajax/saveaccp.php",
...
function getHistory(myinv){
  $.ajax({
    type: "POST",
    url: "/assets/scripts/ajax/gethistoryaccp.php",
    data: "inputinv=" + myinv,
    success: function (response) {
      console.log(response);
      if(response=='0'){
...
$(document).ready(function () {
  ...
  var mf_array=[];
    ...
    $("#btnsearch").click(function(e){
        ...
        $.ajax({
            type: "POST",
            url: "/assets/scripts/ajax/getinvaccp.php",
            data: "inputinv=" + noinv,
            success: function (response) {
