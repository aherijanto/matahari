...
<?php 
				//echo '<div>';
					...
					echo '<br/><br/><div align="center">INPUT QTY RETURN<br/><input type="number" name="qtyret" style="width:40px; text-align:center; font-size:20px;color:red;font-weigth:bold;" placeholder="1" value="1" min="1"></div>';
