				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<div class="row">
							...
							<button type="button" class="btn btn-primary" id="btnHarga1" style="margin-left:10px;height:40px;">Add</button>
						...
						<div class="row">
							...
							<label class="control-label" style="margin-left:10px;margin-top:5px;display:none;">Comments:</label>
							<input type="text" id="commentharga2" class="form-control input-sm" maxlength="50" style="width:200px;margin-top:5px;margin-left:20px;display:none;" disabled>
						...
						<div class="row">
							...
							<label class="control-label" style="margin-left:10px;margin-top:5px;display:none;">Comments:</label>
							<input type="text" id="commentharga3" class="form-control input-sm" maxlength="50" style="width:200px;margin-top:5px;margin-left:20px;display:none;" disabled>
						...
						<div class="row">
							...
							<label class="control-label" style="margin-left:10px;margin-top:5px;display:none;">Comments:</label>
							<input type="text" id="commentharga4" class="form-control input-sm" maxlength="50" style="width:200px;margin-top:5px;margin-left:20px;display:none;" disabled>
						...
						<div class="row">
							...
							<label class="control-label" style="margin-left:10px;margin-top:5px;display:none;">Comments:</label>
							<input type="text" id="commentharga5" class="form-control input-sm" maxlength="50" style="width:200px;margin-top:5px;margin-left:20px;display:none;" disabled>
						...
						<div class="row">
							...
							<label class="control-label" style="margin-left:10px;margin-top:5px;display:none;">Comments:</label>
							<input type="text" id="commentharga6" class="form-control input-sm" maxlength="50" style="width:200px;margin-top:5px;margin-left:20px;display:none;" disabled>
						...
						<div class="row">
							...
							<label class="control-label" style="margin-left:10px;margin-top:5px;display:none;">Comments:</label>
							<input type="text" id="commentharga7" class="form-control input-sm" maxlength="50" style="width:200px;margin-top:5px;margin-left:20px;display:none;" disabled>
						...
						<div class="row">
							...
							<label class="control-label" style="margin-left:10px;margin-top:5px;display:none;">Comments:</label>
							<input type="text" id="commentharga8" class="form-control input-sm" maxlength="50" style="width:200px;margin-top:5px;margin-left:20px;display:none;" disabled>
						...
						<div class="row">
							...
							<label class="control-label" style="margin-left:10px;margin-top:5px;display:none;">Comments:</label>
							<input type="text" id="commentharga9" class="form-control input-sm" maxlength="50" style="width:200px;margin-top:5px;margin-left:20px;display:none;" disabled>
						...
						<div class="row">
							...
							<label class="control-label" style="margin-left:10px;margin-top:5px;display:none;">Comments:</label>
							<input type="text" id="commentharga10" class="form-control input-sm" maxlength="50" style="width:200px;margin-top:5px;margin-left:20px;display:none;" disabled>
