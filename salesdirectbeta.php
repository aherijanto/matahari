	...
	switch($_GET["action"])
	{
		...
		case "add":
            	...
            	try {
                	...
                	$row = $stmt->fetchObject();
               		...
               		if ($total > 0){
               			...
               			$itemname=$row->i_name;
               			$iwarna=$row->i_color;
               			$itemArray = array($mycode=>array('code'=>$mycode,'name'=>$itemname, 'artikel'=>$myarticle,'warna'=>$iwarna,'qty'=>1,'cogs'=>$mysell,'disc1'=>0,'disc2'=>0,'disc3'=>0));
               			if(!empty($_SESSION["cart_item"])){
						...
						//promodoremi($mycode,1,$mysell,0,0,0);
			...
			/*if (isset($_POST['addtolist']))
			{
				...
				promodoremi($itemcode1,$disc1,$disc2,$disc3);
...
<body bgcolor="#00000">
	...
	<div>
		...
		<br/>
		<div class="txt-heading" align="right"><a id="btnNew" href="/salesdirect.php?action=new" style="color:white;background-color:   #2874a6   ; border-radius: 5px;text-decoration: none;padding: 10px" width="120px">New</a>     <a id="btnEmpty" href="/salesdirect.php?action=save" style="color:white;background-color: #229954; border-radius: 5px;text-decoration: none;padding: 10px">Save</a> <a id="btnEmpty" href="/salesdirect.php?action=empty" style="color:white;background-color:  #cb4335  ; border-radius: 5px;text-decoration: none;padding: 10px">Clear</a>
	</div>
...
<table>
	...
	<tr>		
		...
		<form method="post" action="salesdirectbeta.php?action=add">
		<td align="center">
		...
		<form method="post" action="salesdirectbeta.php?action=search">
		<td align="center">
...
$totItem=0;
    ...
    {
		?>
				<form action="salesdirectbeta.php?action=updatearray&codetr=<?php echo $item["code"]; ?>" method="post">
				<tr>
				<td class="auto-style3"><?php echo $item["code"]; ?>
				...
				<td align="center" class="auto-style3">
					<input type="text" name="xqty" value="<?php echo $item['qty'] ?>">
				</td>
				...
				<td align="center" class="auto-style3"><a href="/salesdirectbeta.php?action=remove&codetr=<?php echo $item["code"]; ?>" class="auto-style3" style="color:white;background-color:  #8e44ad; border-radius: 5px;text-decoration: none;padding: 10px 5px;margin:5px;">Remove Item</a></td>
		...
		?>
				...
				<tr>
					<td align="left" style="color: black ;"><?php echo 'Item : '.$totItem.' record(s)';?></td>
					<td align="right" colspan="10" style="color: white ;font-size: 28px;">TOTAL</td>
